#############################################################################
# Makefile for building: sample9_1
# Generated by qmake (3.1) (Qt 6.5.3)
# Project:  sample9_1.pro
# Template: app
# Command: G:\qt\6.5.3\mingw_64\bin\qmake.exe -o Makefile sample9_1.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
QMAKE         = G:\qt\6.5.3\mingw_64\bin\qmake.exe
DEL_FILE      = del
...
QINSTALL      = G:\qt\6.5.3\mingw_64\bin\qmake.exe -install qinstall
QINSTALL_PROGRAM = G:\qt\6.5.3\mingw_64\bin\qmake.exe -install qinstall -exe
DEL_FILE      = del
...
Makefile: sample9_1.pro ../qt/6.5.3/mingw_64/mkspecs/win32-g++/qmake.conf ../qt/6.5.3/mingw_64/mkspecs/features/spec_pre.prf \
		...
		res.qrc
	$(QMAKE) -o Makefile sample9_1.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
